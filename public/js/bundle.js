...
/* eslint-disable */
function _default(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidG91c2lmMTAxIiwiYSI6ImNrN3hhOTh6cTA5cG0zbW8yNDRuajRsdjIifQ.nojSvBs_x4rEnyE-LBzZMg';
...
function _default(type, message) {
  hideAlert();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alerts.default)('error', _context.t0.response.data.message); // console.error(error);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            // });
            if (res.data.status === 'success') {
              location.assign('/login'); // location.reload(true);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateUserAccount.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_UICrsYQjtxjKuBY1WXy2jCWp00LJne2UQu');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // create checkout and charge
          ...
          case 8:
            ...
            (0, _alerts.default)('error', _context.t0.message);
...
if (doms.map) {
  var locations = JSON.parse(doms.map.dataset.locations);
  (0, _mapbox.default)(locations);
}

if (doms.formLogin) {
  doms.formLogin.addEventListener('submit', function (e) {
    e.preventDefault(); // const email = document.getElementById('email').value;
    // const password = document.getElementById('password').value;

    var email = doms.email.value;
    var password = doms.password.value;
    (0, _login.login)(email, password);
  });
}

if (doms.logoutBtn) {
  doms.logoutBtn.addEventListener('click', _login.logout);
}
...
if (doms.userPassword) {
  doms.userPassword.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              currentPassword = doms.passwordCurrent.value;
              password = doms.password.value;
              confirmPassword = doms.passwordConfirm.value;
              _context.next = 7;
              return (0, _updateUserAccount.updateUserAccount)({
